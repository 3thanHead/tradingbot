...
echo "💰 Testing Margin Amount Position Opening"
echo "=========================================="
echo ""
echo "💡 This test will use whatever MARGIN_AMOUNT is configured in the running bot"
echo ""
...
echo "   2. Calculate position size: Margin × Leverage (50:1)"
echo "   3. Calculate units: Position Size ÷ Current Price"
echo "   4. Open SHORT position with calculated units"
echo ""
...
echo "✅ Test complete!"
echo ""
echo "📊 View detailed logs (including margin calculation):"
echo "   docker logs tradingview-webhook-bot | tail -50"
echo ""
echo "💡 Look for these log entries:"
echo "   💰 [MARGIN] Using margin amount: \$XXX.XX"
echo "   💱 [MARGIN CALC] Margin: \$XXX.XX × Leverage: 50x = Position: \$XXXX.XX"
echo "   📊 [PRICE] Current price: X.XXXXX"
echo "   ✅ [UNITS] \$XXX.XX margin = XXXX units"
echo ""
